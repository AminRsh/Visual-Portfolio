...
const Modal = ({ images, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity/80 flex items-center justify-center z-50">
      <div className="relative w-4/5 max-h-[80vh] bg-gray-900 p-4 rounded-lg overflow-y-auto">
        
        <div className="sticky top-0 inset-x-0 bg-gray/900 p-3 z-50 flex justify-end bg-transparent ">
...
const Portfolio = () => {
  ...
  const galleryImages = [
    'img/feature-1.jpg', 'img/feature-2.jpg', 'img/feature-3.jpg', 'img/feature-4.jpg', 
    'img/feature-5.jpg', 'img/feature-6.jpg', 'img/feature-7.jpg', 'img/feature-8.jpg',
  ];
